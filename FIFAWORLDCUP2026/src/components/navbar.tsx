  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className="mx-auto max-w-[1120px] px-4 md:px-8">
        {/* ── Floating pill ── */}
        <div className="mx-auto mt-3 flex h-14 items-center justify-between rounded-xl border border-white/30 bg-white/10 px-5 text-black backdrop-blur-xl shadow-sm transition-all duration-300 hover:border-white/40 hover:bg-white/15">
